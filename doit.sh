...
grep -h find_delete $OUTPUTDIR/* | sort -h > find_delete_$OUTLC.txt
grep -h rsync_empty $OUTPUTDIR/* | sort -h >rsync_empty_$OUTLC.txt
grep -h unlink_perl $OUTPUTDIR/* | sort -h >unlink_perl_$OUTLC.txt
gnuplot 'plotme'
